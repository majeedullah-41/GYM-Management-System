...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::members::list_member_addresses,
            ...
            commands::settings::get_member_form_settings,
            commands::settings::save_member_form_settings,
            commands::settings::get_payment_form_settings,
            commands::settings::save_payment_form_settings,
